 ...
 *
 * [createClient] mirrors DatabaseClientFactory.create() logic, accepting the flag
 * explicitly so it can be tested independently of BuildConfig.
 */
private fun createClient(isSupabase: Boolean): Any = if (isSupabase) StubSupabaseClient() else StubLocalClient()
