...
class RegisterUseCaseTest {
    ...
    @Test
    fun `returns Right with AuthUser on successful registration`() =
        runTest {
            val user =
    ...
    @Test
    fun `returns Left with UserAlreadyExists when email is taken`() =
        runTest {
    ...
    @Test
    fun `forwards all parameters to repository`() =
        runTest {
